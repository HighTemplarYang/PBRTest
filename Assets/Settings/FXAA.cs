...
public class FXAA : ScriptableRendererFeature
{
    ...
    {
        public string passRenderName = "FXAA";
        public Material passMat;
        [Range(0, 1)] public float minthreshold = 0.8f;
    ...
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            cmd.SetGlobalFloat("_MinThreshold", minthreshold);
    ...
    public override void Create()
    {
        ...
        m_ScriptablePass.minthreshold = setting.minthreshold;
